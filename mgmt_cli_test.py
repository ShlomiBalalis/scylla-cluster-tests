...
class BackupFunctionsMixIn(LoaderUtilsMixin):
    ...
    def restore_schema_with_task(self, mgr_cluster, timeout):
        snapshot_tag = "sm_20230220124823UTC"  # backup_task.get_snapshot_tag()
    ...
    def restore_data_with_task(self, mgr_cluster, timeout):
        snapshot_tag = "sm_20230220124823UTC"  # backup_task.get_snapshot_tag()
...
class MgmtCliTest(BackupFunctionsMixIn, ClusterTester):
    ...
    def test_backup_replace_node_and_restore_schema_with_task(self):
        ...
        self.restore_schema_with_task(mgr_cluster=mgr_cluster, timeout=1000)
        self.restore_data_with_task(mgr_cluster=mgr_cluster, timeout=14000)
